...
trait EntrustRoleTrait
{
    ...
    {
        return $this->belongsToMany(Config::get('auth.providers.'.Config::get('auth.guards.'.Config::get('auth.defaults.guard').'.provider').'.model'), Config::get('entrust.role_user_table'),Config::get('entrust.role_foreign_key'),Config::get('entrust.user_foreign_key'));
