...
class EntrustRole extends Ardent {
	...
	public function users() {
		return $this->belongsToMany(Config::get('auth.model'), Config::get('entrust::user_roles_table'));
	}
	...
	public function beforeDelete($forced = false) {
		try {
			DB::table(Config::get('entrust::user_roles_table'))->where('role_id', $this->id)->delete();
